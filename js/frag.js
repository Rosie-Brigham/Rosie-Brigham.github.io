...
void main(void)
{
    ...
    vec3 hsv1 = vec3(0.9, 0.2, 0.85);
    vec3 hsv2 = vec3(0.6 + 0.07, 0.85, 0.75);
    ...
    movement *= rotation2d(u_time * 0.0005);
	...
	float gap = mix(0.3, 0.01, strength);
    // float mixer = smoothstep(0.0, gap, f) - smoothstep(1.0 - gap, 1.0, f);
    float mixer = smoothstep(0.0, 0.03, f) - smoothstep(0.5, 0.53, f);
